...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        btn.append(
            [InlineKeyboardButton("🔙《  BACK", callback_data=f"next_{req}_{key}_{off_set}"), InlineKeyboardButton(f"E͏N͏D͏ P͏A͏G͏E͏ {round(int(offset)/10)+1} / {round(total/10)}", callback_data="pages")]
        )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
                        InlineKeyboardButton('Nᴇᴡ Rᴇʟᴇᴀsᴇ 🍿', url='https://t.me/MovieHub_OTT'),
                        InlineKeyboardButton('Sʜᴀʀᴇ Nᴏᴡ  ➢', url='https://t.me/share/url?url=https://t.me/MH_LinkZ')
                  ]]
        ...
        buttons = [
                    [
                        InlineKeyboardButton('⌨ Group ', url='https://t.me/MoviesHubGroup2')
                    ]
                    ]
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text=f"🗒  P͏A͏G͏E͏ 1/{round(int(total_results)/10)}",callback_data="pages"), InlineKeyboardButton(text="N͏E͏X͏T͏ P͏A͏G͏E͏  ➪",callback_data=f"next_{req}_{key}_{offset}")]
        )
    else:
        btn.append(
            [InlineKeyboardButton(text="🗒  P͏A͏G͏E͏ 1/1",callback_data="pages")]
        )
